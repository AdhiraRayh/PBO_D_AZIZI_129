...
public class tugas1 { // Mendeklarasikan class utama
    public static void main(String[] args) { // method utama
        ...
        if (pilihan == 1) { // Jika pengguna memilih 1 (Admin)
            ...
            if (username.equals("Admin129") && password.equals("Password129")) { // login Admin
            ...
            if (nama.equals("Azizi Adhira Rayhandra") && nim.equals("202410370110129")) { // login Mahasiswa
        ...
        scanner.close(); // Menutup Scanner untuk mencegah kebocoran
    }
}